...
<div class="d-none d-sm-block">
    <h5 class="m-0 fw-semibold text-dark">{{ __('Port Dataset Management') }}</h5>
    <div class="text-muted" style="font-size: 0.8rem;">{{ __('Manage global port dataset used for mapping and risk analysis') }}</div>
</div>
@endsection
